...
def postgres_p1_telegram():
    ...
    values = "values (\'" + \
         ...
         p1_channel_1.timestamp + "\'::timestamp," + \
         ...
         p1_channel_2.timestamp + "\'::timestamp," + \
         ...
         p1_channel_3.timestamp + "\'::timestamp," + \
         ...
         p1_channel_4.timestamp + "\'::timestamp," + \
